...
for i in range(11,21):
    for j in range(10, 0, -1):
        result = result + str(hex(i)[2:].zfill(2).format(j, 'b').upper()) + " "
        result = result + str(hex(j)[2:].zfill(2).format(j, 'b').upper()) + " "
        result = result + str(hex(i)[2:].zfill(2).format(j, 'b').upper()) + " "
        result = result + str(hex(j)[2:].zfill(2).format(j, 'b').upper()) + " "
