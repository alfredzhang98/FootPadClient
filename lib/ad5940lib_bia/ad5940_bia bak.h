...
*****************************************************************************/
#pragma once
#ifndef _AD5940_BIA_H_
#define _AD5940_BIA_H_
...
/* Application related parameters */
    ...
    uint32_t HsDacUpdateRate;     /* DAC update rate is SystemClock/Divider. The available value is 7 to 255. Set to 7 for better performance */
